...
description: Cómo manejar eventos en React.
---
...
<iframe className='youtube-video' src="https://www.youtube.com/embed/vmlqBnMxOX4?si=K8-iGXrXbgAj6bfA" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>