...
import blogImage1 from './images/blog3.jpg'
import blogImage2 from './images/blog2.jpg'
import blogImage3 from './images/blog5.png'
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {posts.map((post, index) => (
          <article key={post.url} className='relative flex gap-5'>
            <Image className='' src={blogImages[index]} width={64*2} height={96*2} alt='code' />
            
            <div className='flex flex-col'>
              <p className='text-4xl text-Hover font-extrabold'>{`0${index+1}`}</p>
              <Link
                href={post.url}
