...
export const TechCard = ({
  ...
  return (
    <div
      data-card='true'
      className='rounded-xl border bg-fd-card p-4 text-fd-card-foreground transition-colors @max-lg:col-span-full max-w-[300px] max-h-[300px] flex flex-col justify-between'
    >
      <div>
